...
Furthermore, the value of $\delta^0_{TLS}$ is also sensitive to temperature as follows \cite{Gao2008}
...
\begin{equation}
    \label{Qi(T)}
    \frac{1}{Q_i(T)} = F \delta^0_{TLS} \tanh\left(\frac{\hbar \omega}{2 k_B T}\right)
\end{equation}
