...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/4H/4H_mask.png}
    \caption{Positive layout used for the wet etching process.}
...
\begin{figure}
    \centering
    \includegraphics{figures/4H/4H_mask_neg.png}
    \caption{Negative layout used for the lift-off process.}
...
\textcolor{red}{Additionally, in every step of this measurement plan, several iterations were planned to be carried out on each step, with increasingly less attenuation. This would then allow us to perform a sweep in power. Moreover, this is of interest in order to later on be able to tell whether the energy losses where due to dielectric TLS.}
...
\begin{figure}[h]
    ...
    \caption{Diamond current density distribution.}
    \label{fig:DiamondCurrent}
\end{figure}
...
\begin{figure}
    ...
    \begin{subfigure}{0.4\textwidth}
        ...
        \label{fig:6HSiC_out}
    \end{subfigure}
    \caption{6H-SiC current density distribution.}
